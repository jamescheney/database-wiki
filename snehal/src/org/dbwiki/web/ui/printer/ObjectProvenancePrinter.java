...
public class ObjectProvenancePrinter implements HtmlContentPrinter {
	...
	public void print(HtmlLinePrinter body) throws org.dbwiki.exception.WikiException {
		...
		int nodeID = ((NodeIdentifier)_request.wri().resourceIdentifier()).nodeID();
		
		body.openTR();
		body.add("<td style=\'border: medium solid black;\' colspan=\"5\"><a id=\"VersionComparisonID\" onClick=\"CompareVersions('" + nodeID + "')\">Compare two versions</a>");
		body.closeTD();
		body.closeTR();
		body.openTR();
		body.add("<td style=\'border: medium solid black;\' colspan=\"5\"><div id=\"comparisonResult\">");
		body.add("</div");
		body.closeTD();
		body.closeTR();
		body.openTR();
		body.add("<td style=\'border: medium solid black;\' colspan=\"5\"><a id=\"VersionTreeID\" onClick=\"DisplayVersionTree('" + nodeID + "')\">Display Tree</a>");
		body.add("<div id=\"container\">");
		body.add("<div id=\"center-container\">");
		body.add("<div id=\"infovis\"></div>");
		body.add("</div");
		body.add("<div id=\"log\"></div>");
		body.add("</div");
		body.closeTD();
		body.closeTR();
		body.closeTABLE();		
	...
	private void printProvenanceLine(Version version, String css, HtmlLinePrinter body) throws org.dbwiki.exception.WikiException {
		...
		body.openTR();
		body.openTD(css);
		body.add("<INPUT TYPE=\"CHECKBOX\" NAME=\"versionComparison\" VALUE=\"" + version.number() + "\">");
		body.closeTD();
