...
/** NodeValueReader provides callbacks to handle open and close element tags
 * It builds a string carrying an XML serialization of the value that has been read so far
 * It checks for well-nesting of tags. 
 * FIXME #xmlparsing: This does not seem to be doing very much.
 * 
 * @author jcheney
 *
 */
