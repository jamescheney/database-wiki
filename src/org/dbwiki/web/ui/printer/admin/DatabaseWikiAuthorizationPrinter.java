	...
	public void print(HtmlLinePrinter printer) throws WikiException {
		...
		while(_user_listing.get(i)!=null){
			...
			if(flag){
				...
				printer.addBR();
				printer.addRADIOBUTTON("No", login+WikiServer.propertyReadPermission, "NoPermission", (_authorizationListing.get(j).is_read() != DatabaseWikiProperties.HoldPermission));
				printer.closeTD();
				//insert permission
				printer.openTD(CSS.CSSFormControl);
				printer.addRADIOBUTTON("Yes", login+WikiServer.propertyInsertPermission, "HoldPermission", (_authorizationListing.get(j).is_insert() == DatabaseWikiProperties.HoldPermission));
				printer.addBR();
				printer.addRADIOBUTTON("No", login+WikiServer.propertyInsertPermission, "NoPermission", (_authorizationListing.get(j).is_insert() != DatabaseWikiProperties.HoldPermission));
				printer.closeTD();
				//delete permission
				printer.openTD(CSS.CSSFormControl);
				printer.addRADIOBUTTON("Yes", login+WikiServer.propertyDeletePermission, "HoldPermission", (_authorizationListing.get(j).is_delete() == DatabaseWikiProperties.HoldPermission));
				printer.addBR();
				printer.addRADIOBUTTON("No", login+WikiServer.propertyDeletePermission, "NoPermission", (_authorizationListing.get(j).is_delete() != DatabaseWikiProperties.HoldPermission));
				printer.closeTD();
				//update permission
				printer.openTD(CSS.CSSFormControl);
				printer.addRADIOBUTTON("Yes", login+WikiServer.propertyUpdatePermission, "HoldPermission", (_authorizationListing.get(j).is_update() == DatabaseWikiProperties.HoldPermission));
				printer.addBR();
				printer.addRADIOBUTTON("No", login+WikiServer.propertyUpdatePermission, "NoPermission", (_authorizationListing.get(j).is_update() != DatabaseWikiProperties.HoldPermission));
				printer.closeTD();
				//manage by entry
				printer.openTD(CSS.CSSFormControl);
