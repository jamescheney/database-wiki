...
public class AZMultiPageIndexPrinter extends IndexContentPrinter {
	...
	private void addContainer(DatabaseIdentifier databaseIdentifier, ContentIndexContainer container, RequestParameterVersion versionParameter, HtmlLinePrinter body) throws org.dbwiki.exception.WikiException {
		...
		for (int iEntry = 0; iEntry < container.size(); iEntry++) {
			body.add("<li>" + this.getLink(databaseIdentifier, container.get(iEntry), versionParameter) + "</li>");
		}
		body.add("</ul>");
	}
}
