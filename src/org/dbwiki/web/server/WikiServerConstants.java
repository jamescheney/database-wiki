...
public interface WikiServerConstants {
	...
	public static final String RelAuthenticationColRead = "read";
	public static final String RelAuthenticationColInsert = "insert";
	public static final String RelAuthenticationColDelete = "delete";
	public static final String RelAuthenticationColUpdate = "update";
}
