...
/** A full-text search query.  The constructor parses the string into a set of keywords,
 * which are then used to build an SQL query to fetch the entries that mention the keywords from the DB.
 * FIXME #security: Be careful about SQL injection here!
 * @author jcheney
 *
 */
