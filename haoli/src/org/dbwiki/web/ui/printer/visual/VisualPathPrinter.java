 ...
 *
 */
public class VisualPathPrinter implements HtmlContentPrinter {
	/*
	 * Private Variables
	 */
	
	private DatabaseLayouter _layouter;
	private WikiVisualRequest _request;
	
	/*
	 * Constructors
	 */
	
	public VisualPathPrinter(WikiVisualRequest request, DatabaseLayouter layouter) {
		_request = request;
		_layouter = layouter;
	}
