...
public class RDBMSDatabaseTextNode extends DatabaseTextNode {
	...
	public RDBMSDatabaseTextNode(int id, DatabaseAttributeNode parent, Timestamp timestamp, String value, AnnotationList annotation) {
		super(parent, timestamp, value, annotation);
		
		_identifier = new NID(id);
	}

	public RDBMSDatabaseTextNode(int id, DatabaseAttributeNode parent, Timestamp timestamp, String value) {
