...
public abstract class DatabaseTextNode extends DatabaseNode {
	...
	public DatabaseTextNode(DatabaseAttributeNode parent, Timestamp timestamp, String value, AnnotationList annotation) {
	...
	public String text() throws org.dbwiki.exception.WikiException {
		return this.value();
	}
