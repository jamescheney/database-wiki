 ...
 * FileServer
 * 
 * Configures a Web server/HttpHandler that sits on a given directory and by default serves files from it. 
 * 
 * @author jcheney
 *
 */
public abstract class FileServer implements HttpHandler {
	...
	public void sendFile(HttpExchange exchange) throws java.io.IOException, org.dbwiki.exception.WikiException {
