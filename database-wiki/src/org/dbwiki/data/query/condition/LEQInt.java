...
public class LEQInt extends ValueOp {
	...
	public AttributeCondition getQueryCondition(AttributeSchemaNode entity, boolean isNegated) {
		...
		return new AttributeValueCondition(entity, AttributeCondition.LEQ, String.valueOf(_value), isNegated);
	}
