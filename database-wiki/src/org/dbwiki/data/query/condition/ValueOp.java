...
/** Interface for value operators for INTEGERs and STRINGs.
 * 
 * @author hmueller
 *
 */
...
public abstract class ValueOp {
	...
	public abstract AttributeCondition getQueryCondition(AttributeSchemaNode entity, boolean isNegated);
