...
public class DatabaseNodeValue {
	...
	//private Vector<DatabaseTextNode> _Versionvalues;
	...
	public Vector<DatabaseTextNode> getValue(){
	...
	public void SerVersionValue(int i)
	{
//		DatabaseTextNode DT0 = _values.get(0);
//		
//		for (int i =1; i<_values.size(); i++)
//		{
		  DatabaseTextNode DTi = _values.get(i);
		  DatabaseTextNode NewDTi = new DatabaseTextNodeVersion(DTi.parent(), DTi.getTimestamp(), DTi.getValue(),DTi.annotation());
		  _values.removeAll(_values);
		  _values.add(NewDTi);
		//  _Versionvalues.add(NewDTi);
