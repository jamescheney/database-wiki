...
import org.dbwiki.data.query.xaql.VersionClause;
...
public class XAQLQueryStatement extends QueryStatement {
	...
	public QueryResultSet execute() throws WikiException {
		...
		QueryResultSet result = null;
			...
			VersionClause versionClause = _query.getVersionClause();
		...
		if(versionClause != null && versionClause.isComparing())  {
			// change the result to represent difference between versions
			/*
			
			ResultGroupNode a = (ResultGroupNode)result.getNodes().get(0);
			ResultGroupNode a1 = a;
			ResultGroupNode a2 = a;
			
			RDBMSDatabaseAttributeNode b = (RDBMSDatabaseAttributeNode)a.getChildren().getElement().get(1);
			RDBMSDatabaseAttributeNode b1 = b;
			RDBMSDatabaseAttributeNode b2 = b;
			RDBMSDatabaseTextNode c1 = (RDBMSDatabaseTextNode)b.getValue().get(0);
			RDBMSDatabaseTextNode c2 = (RDBMSDatabaseTextNode)b.getValue().get(1);
			RDBMSDatabaseTextNode c3 = (RDBMSDatabaseTextNode)b.getValue().get(2);
			RDBMSDatabaseTextNode c4 = (RDBMSDatabaseTextNode)b.getValue().get(3);
			
			//String c = b.getValue().get(0).getValue();
			//System.out.println(c);
			

			b1.getValue().getValue().clear();
			b1.getValue().getValue().add(c1);
			
//		
//			b2.getValue().getValue().clear();
//			b2.getValue().getValue().add(c2);
//			
//			RDBMSDatabaseAttributeNode b3 = b;
//			b3.getValue().getValue().clear();
//			b3.getValue().getValue().add(c3);
//			
//			RDBMSDatabaseAttributeNode b4 = b;
//			b4.getValue().getValue().clear();
//			b4.getValue().getValue().add(c4);
			

			a1.getChildren().getElement().set(1, b1);			
//			a2.getChildren().getElement().set(1, b2);
//			
//			ResultGroupNode a3 = a;
//			a3.getChildren().getElement().set(1, b3);
//			
//			ResultGroupNode a4 = a;
//			a4.getChildren().getElement().set(1, b4);
