...
public abstract class DatabaseGroupNode extends DatabaseElementNode {
	...
	public DatabaseGroupNode(GroupSchemaNode schema, DatabaseGroupNode parent, TimeSequence timestamp, AnnotationList annotation, /*int pre, int post,*/ String dewey) {
