...
public abstract class DatabaseElementNode extends DatabaseNode {
	...
	public DatabaseElementNode(SchemaNode schema, DatabaseGroupNode parent, TimeSequence timestamp, AnnotationList annotation, /*int pre, int post,*/ String dewey) {
		super(parent, timestamp, annotation, /*pre, post,*/ dewey);
		_schema = schema;
		_label = schema.label();
	}
