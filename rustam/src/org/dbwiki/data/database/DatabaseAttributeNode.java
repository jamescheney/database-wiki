...
public abstract class DatabaseAttributeNode extends DatabaseElementNode {
	...
	public DatabaseAttributeNode(AttributeSchemaNode schema, DatabaseGroupNode parent, TimeSequence timestamp, AnnotationList annotation, /*int pre, int post,*/ String dewey) {
	...
	public abstract void add(String value, TimeSequence timestamp, /*int pre, int post,*/ String dewey);
