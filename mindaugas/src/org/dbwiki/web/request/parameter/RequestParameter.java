...
public class RequestParameter {
	...
	public static final String ParameterHistoryTree         = "history_tree";
	public static final String ParameterStructureTree       = "structure_tree";
	public static final String ParameterExportHistoryDOT    = "history_dot";
	public static final String ParameterExportStructureDOT  = "structure_dot";
