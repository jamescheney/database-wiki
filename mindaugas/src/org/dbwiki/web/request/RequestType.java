...
public class RequestType {
	...
	//?history_tree
	private static final byte requestTypeHistoryTree = 24;
	//?history_tree
	private static final byte requestTypeStructureTree = 25;
	//?history_dot
	private static final byte requestTypeExportHistoryDOT = 26;
	//?structure_dot
	private static final byte requestTypeExportStructureDOT = 27;
	//?value
	private static final byte requestTypeNodeValue=28;
	...
	public RequestType(RequestURL url) {
		...
		if (parameters.hasParameter(RequestParameter.ParameterAction)) {
			...
			} else if (parameters.hasParameter(RequestParameter.ParameterHistoryTree)) {
				//?history_tree
				_type = requestTypeHistoryTree;
			} else if (parameters.hasParameter(RequestParameter.ParameterStructureTree)) {
				//?structure_tree
				_type = requestTypeStructureTree;
			} else if (parameters.hasParameter(RequestParameter.ParameterExportHistoryDOT)) {
				//?history_dot
				_type = requestTypeExportHistoryDOT;
			} else if (parameters.hasParameter(RequestParameter.ParameterExportStructureDOT)) {
				//?structure_dot
				_type = requestTypeExportStructureDOT;
			} else if (parameters.hasParameter(RequestParameter.ParameterValue)) {
				//?value
				_type = requestTypeNodeValue;
	...
	public boolean isHistoryTree() {
		return (_type == requestTypeHistoryTree);
	}
	
	public boolean isStructureTree() {
		return (_type == requestTypeStructureTree);
	}
	...
	public boolean isExportHistoryDot() {
		return (_type == requestTypeExportHistoryDOT);
	}
	
	public boolean isValue() {
		return (_type == requestTypeNodeValue);
	}
	
	public boolean isExportStructureDot() {
		return (_type == requestTypeExportStructureDOT);
	}
