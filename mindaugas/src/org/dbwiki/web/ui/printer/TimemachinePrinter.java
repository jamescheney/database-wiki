...
/** Prints out the time machine bar
 * 
 * @author jcheney
 *
 */
public class TimemachinePrinter implements HtmlContentPrinter {
	...
	public void print(HtmlLinePrinter body) throws org.dbwiki.exception.WikiException {
		...
		String updateVisualisation = "<a CLASS=\"" + CSS.CSSTimemachineTab + "\" HREF=\"" + _request.wri().getURL() + "?" + RequestParameter.ParameterHistoryTree + "\">Visualisation</a>";
		
		if (_request.parameters().hasParameter(RequestParameter.ParameterHistoryTree)) {
		updateVisualisation = "Visualisation";
		} else if (_request.parameters().hasParameter(RequestParameter.ParameterChangesSince)) {
