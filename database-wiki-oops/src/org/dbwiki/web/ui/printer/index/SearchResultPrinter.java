...
public class SearchResultPrinter extends IndexLinkPrinter implements HtmlContentPrinter {
	/*
	 * Private Variables
	 */
	...
	public void print(HtmlLinePrinter body) throws org.dbwiki.exception.WikiException {
		...
		while ((entry = iterator.next()) != null) {
			body.add("<li>" + this.getLink(_request.wri().databaseIdentifier(), entry, versionParameter) + "</li>");
		}
