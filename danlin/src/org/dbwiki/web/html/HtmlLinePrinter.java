...
public class HtmlLinePrinter  {
        ...
        /*public void addANNImg(String src){
                this.text("<div z-index:0;>");
                this.text("<img src=\""+src+"\" width = 700 height = 500 ></div>");
        }*/
        /*public void addAPP() {
                this.text("<APPLET CODE=\"file:///C:/Users/thinkpad/danlin/src/org/dbwiki/danlin/Paint.class\">");
        }*/
       
        public void addJS() {
                /*System.out.println("flag1");
                this.text("<div id=\"canvasDiv\"></div>");
                this.text("<script type=\"text/javascript\"> $(document).ready(function() {prepareCanvas();     });</script>");*/
                //this.text("<input type=\"hidden\"   id=\"demo_input\"  value=\"aaa\">");
                this.text("<iframe name=\"content_frame\" marginwidth=0 marginheight=0 width=900 height=550 src=\"canvas/canvas.html\" frameborder=0></iframe>");
        }
       
        public void addcanvas1(String src){
                this.text("<link href= 'canvas.css' type=\"text/css\" rel=\"Stylesheet\"/>");  
                if(src!=""){
                	imageName=src;
                }
                else{
                ...
                /*this.text("<div style='float:left';>");
                this.text("<div style=\"width:100px;position:absolute;left:270px;\">");
                this.text("<img src=\""+imageName+"\" width = 500 height = 500 ></div>");
                this.text("<div style=\"width:100px;position:absolute;\">");
                this.text("<canvas id=\"canvas\"></canvas>");          
                this.text("<canvas id=\"canvas_bak\"></canvas></div></div>");*/
                this.text("<div style='float:left';z-index:-1;padding-left:30px;>");
                this.text("<img src=\""+imageName+"\" width = 500 height = 500 ></div>");
                this.text("<div style=position:absolute;z-index:0;>");          
                this.text("<canvas id=\"canvas\"></canvas>");          
                this.text("<canvas id=\"canvas_bak\"></canvas></div>");
                
        }

        public void addcanvas2(String src){
            this.text("<link href= 'canvas.css' type=\"text/css\" rel=\"Stylesheet\"/>");
            this.text("<div style='float:left';id=\"drawController\";>");  
           /* this.text("<img src = 'image/cancel.png' width = '20px;' height = '20px;'  onclick=\"cancel(this)\" class = 'border_nochoose' title = 'undo'/><br/>");
            this.text("<img src = 'image/next.png' width = '20px;' height = '20px;'  onclick=\"next(this)\" class = 'border_nochoose' title = 'redo'/><br/>");
            this.text("<input id=\"chooseColor\"  type=\"button\"  class = 'i1 border_nochoose' onclick=\"showColor(this)\" title = 'color'/><br/>");*/
            this.text("<img src = 'image/square.png'  width = '20px;' height = '20px;'  onclick=\"draw_graph('square',this)\" class = 'border_nochoose' title = 'square'/><br/>");
            this.text("<img src = 'image/line.png' width = '20px;' height = '20px;'  onclick=\"draw_graph('line',this)\" class = 'border_nochoose' title = 'line'/><br/>");
            this.text("<img src = 'image/rubber.png' width = '20px;' height = '20px;'  onclick=\"draw_graph('rubber',this)\" class = 'border_nochoose' title = 'rubber'/><br/>");
            this.text("<img src = 'image/drag.png' width = '20px;' height = '20px;'  onclick=\"draw_graph('drag',this)\" class = 'border_nochoose' title = 'drag'/><br/>");
            this.text("<img  id=\"chooseSize\" src = 'image/line_size_1.png' width = '20px;' height = '20px;' onclick=\"showLineSize(this)\" class = 'border_nochoose' title = 'size'/><br/>");
            this.text("<img src = 'image/xx.png' width = '20px;' height = '20px;'  onclick=\"clearContext('1')\" class = 'border_nochoose' title = 'clear'/><br/>"); 
            this.text("</div>");  
            this.text("<div style='float:left';z-index:0;padding-left:30px;>");
            if(src!=""){
            	imageName=src;
            }
            else{
            ...
            this.text("<div style=position:absolute;>");    //left:245px    
            this.text("<div style='margin-left:40px;'>"); 
            this.text("<canvas id=\"canvas\"></canvas>"); 
            this.text("<canvas id=\"canvas_bak\"></canvas></div></div>");
           /* this.text("<div id=\"color\" class=\"color\" style=\"z-index:99\">");
            this.text("<input class=\"i1\" type=\"button\"/>");
            this.text("<input class=\"i2\" type=\"button\"/>");
            this.text("<input class=\"i3\" type=\"button\"/>");
            this.text("<input class=\"i4\" type=\"button\"/>");
            this.text("<input class=\"i5\" type=\"button\"/>");
            this.text("<input class=\"i6\" type=\"button\"/>");
            this.text("<input class=\"i7\" type=\"button\"/>");
            this.text("<input class=\"i8\" type=\"button\"/>");
            this.text("<input class=\"i9\" type=\"button\"/></div>"); */     
            this.text("<div id=\"line_size\"  class = \"border_nochoose\" style=\"z-index:99\">");
            this.text("<img src=\"image/line_size_1.png\" width = '80px;' height = '12px;' onclick=\"chooseLineSize(1)\"><br/>");
            this.text("<img src=\"image/line_size_3.png\" width = '80px;' height = '12px;' onclick=\"chooseLineSize(3)\"><br/>");
            this.text("<img src=\"image/line_size_5.png\" width = '80px;' height = '12px;' onclick=\"chooseLineSize(5)\"><br/>");
            this.text("<img src=\"image/line_size_7.png\" width = '80px;' height = '12px;' onclick=\"chooseLineSize(7)\"><br/></div>");
            
    }
        //public void addJS() {
        //      this.text("<script language=\"JavaScript\" src=\"Paint.js\">");
        //      System.out.println("flag1");
        //}
