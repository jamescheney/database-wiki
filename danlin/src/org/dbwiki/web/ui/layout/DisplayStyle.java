...
public class DisplayStyle {
	...
	//
//	public static final String styleImage = "image";
	//
	...
	public DisplayStyle(String style) {
		if ((!styleGroup.equalsIgnoreCase(style)) && (!styleList.equalsIgnoreCase(style)) && (!styleTable.equalsIgnoreCase(style))/*&& (!styleImage.equalsIgnoreCase(style))*/) {
			_style = DefaultStyle;
		} else {
			_style = style;
		}
...
//		return (styleImage.equalsIgnoreCase(_style));
//	}
	//
}
