...
public class ImportPrinter implements HtmlContentPrinter {
	...
	public void print(HtmlLinePrinter printer) throws WikiException {
		...
		printer.text("<script type=\"text/javascript\" src=\"http://ajax.googleapis.com/ajax/libs/jquery/1.4.2/jquery.js\"></script>");
		printer.text("<script src='jquery-1.4.min.js'></script>");
	    printer.text("<script src='draw.js'></script>");
	}
