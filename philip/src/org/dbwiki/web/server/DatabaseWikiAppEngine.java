 ...
 * 
 */
public class DatabaseWikiAppEngine extends DatabaseWiki {
	
	protected WikiServerAppEngine _server;
	...
	public DatabaseWikiAppEngine(int id, String name, String title,
			int autoSchemaChanges, int authenticationMode,
			DatabaseConnector connector, WikiServerAppEngine server,
